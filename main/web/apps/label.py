...
def app():
    ...
    path = st.sidebar.text_input("Сохранить в расширении Excel путь: ")
    ...
    if canvas_result.json_data is not None:
        ...
        if path:
            objects.to_excel(f'{path}_excel.xlsx') 
            download_link = get_download_link(f'{path}_excel.xlsx', f"Скачать эксель файл")
